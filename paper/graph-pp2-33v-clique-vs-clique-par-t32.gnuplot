...
set terminal tikz standalone color size 1.8in,1.4in font '\scriptsize' preamble '\input{gnuplot-preamble}'
set output "gen-graph-pp2-33v-clique-vs-clique-par-t32.tex"
