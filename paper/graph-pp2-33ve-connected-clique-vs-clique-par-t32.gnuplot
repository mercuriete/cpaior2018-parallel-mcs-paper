...
set terminal tikz standalone color size 1.8in,1.3in font '\scriptsize' preamble '\input{gnuplot-preamble}'
set output "gen-graph-pp2-33ve-connected-clique-vs-clique-par-t32.tex"

seqcol=2
parcol=4
starttime=5e2
runtimes="../experiments/fatanode-results/mcs33ve-connected/runtimes.data"
