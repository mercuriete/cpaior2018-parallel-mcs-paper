...
set terminal tikz standalone color size 1.4in,1.3in font '\scriptsize' preamble '\input{gnuplot-preamble}'
...
plot "../experiments/fatanode-results/mcs33ve-connected/runtimes.data" u (shist($2,$4,width)):(fhist($2,$4)) smooth freq w boxes lc '#812581'
