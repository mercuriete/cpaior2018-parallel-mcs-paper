...
set terminal tikz standalone color size 2.4in,2.4in font '\footnotesize' preamble '\input{gnuplot-preamble}'
...
plot \
    ...
    '<./asify.sh gen-as-alt-33v-clique-par.data gen-as-alt-33v-clique-seq.data' u 3:($3/$2) w l title 'Vertex' at end ls 3, \
    '<./asify.sh gen-as-alt-33ved-clique-par.data gen-as-alt-33ved-clique-seq.data' u 3:($3/$2) w l title 'Both, dir.' at end ls 5, \
    '<./asify.sh gen-as-alt-plain-connected-clique-par.data gen-as-alt-plain-connected-clique-seq.data' u 3:($3/$2) w l title 'Unlabelled, conn.' at end ls 7, \
    '<./asify.sh gen-as-alt-33ve-connected-clique-par.data gen-as-alt-33ve-connected-clique-seq.data' u 3:($3/$2) w l title 'Both, conn.' at end ls 8
