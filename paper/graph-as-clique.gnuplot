...
plot \
    ...
    '<./asify.sh gen-as-alt-33ved-clique-par.data gen-as-alt-33ved-clique-seq.data' u 3:($3/$2) w l title 'Both, directed' at end ls 4, \
    '<./asify.sh gen-as-alt-plain-connected-clique-par.data gen-as-alt-plain-connected-clique-seq.data' u 3:($3/$2) w l title 'Unlabelled, connected' at end ls 6, \
    '<./asify.sh gen-as-alt-33ve-connected-clique-par.data gen-as-alt-33ve-connected-clique-seq.data' u 3:($3/$2) w l title 'Both, connected' at end ls 7
