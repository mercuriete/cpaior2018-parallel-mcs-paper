...
set output "gen-graph-as-33ve-connected.tex"
...
plot \
    '<./asify.sh gen-as-33ve-connected-clique-par.data gen-as-33ve-connected-clique-seq.data' u 3:($3/$2) w l title 'Clique' ls 2, \
    '<./asify.sh gen-as-33ve-connected-mcsplit-par.data gen-as-33ve-connected-mcsplit-seq.data' u 3:($3/$2) w l title 'McSplit' ls 5
