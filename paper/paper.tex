...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[scale=0.25]%{{{
        ...
        \begin{scope}[xshift=12cm]
            ...
            \node[draw, circle, draw=uofgsandstone!60, fill=white, inner sep=0.2pt, font=\small] (M7) at ($(330:1.5) + (M6)$) {\phantom{0}};
            \node[draw, circle, fill=magmaorange, inner sep=0.2pt, font=\small] (M8) at ($(210:1.5) + (M6)$) {\phantom{0}};
...
two graphs \cite{DBLP:journals/prl/Bunke97,DBLP:journals/prl/FernandezV01,o:Kriege15}: to determine
the difference between two graphs, we instead find what they have in common.
Because of this, maximum common subgraph problems frequently arise in biology and chemistry
...
\begin{figure}[p]
    ...
    \begin{tikzpicture}%{{{
        ...
        \node[anchor=west, right = 0.3 of C1.east] (C2) {\includegraphics*{gen-graph-histogram-plain-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C2.east] (C3) {\includegraphics*{gen-graph-pp-plain-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, left = 0.2 of C1.east] (C0) at (0, 0) {\rotatebox{90}{\scriptsize Unlabelled}};
    \end{tikzpicture}

    \centering
    \begin{tikzpicture}%{{{
        \node[anchor=west] (C1) {\includegraphics*{gen-graph-scatter-33v-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C1.east] (C2) {\includegraphics*{gen-graph-histogram-33v-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C2.east] (C3) {\includegraphics*{gen-graph-pp-33v-clique-vs-clique-par-t32.pdf}};
    ...
    \begin{tikzpicture}%{{{
        ...
        \node[anchor=west, right = 0.3 of C1.east] (C2) {\includegraphics*{gen-graph-histogram-33ved-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C2.east] (C3) {\includegraphics*{gen-graph-pp-33ved-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, left = 0.2 of C1.east] (C0) at (0, 0) {\rotatebox{90}{\scriptsize Both labelled,}};
    ...
    \begin{tikzpicture}%{{{
        ...
        \node[anchor=west, right = 0.3 of C1.east] (C2) {\includegraphics*{gen-graph-histogram-plain-connected-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C2.east] (C3) {\includegraphics*{gen-graph-pp-plain-connected-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, left = 0.2 of C1.east] (C0) at (0, 0) {\rotatebox{90}{\scriptsize Unlabelled,}};
    ...
    \begin{tikzpicture}%{{{
        ...
        \node[anchor=west, right = 0.3 of C1.east] (C2) {\includegraphics*{gen-graph-histogram-33ve-connected-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, right = 0.3 of C2.east] (C3) {\includegraphics*{gen-graph-pp-33ve-connected-clique-vs-clique-par-t32.pdf}};
        \node[anchor=west, left = 0.2 of C1.east] (C0) at (0, 0) {\rotatebox{90}{\scriptsize Vertex labelled,}};
        \node[anchor=west, right = -0.2 of C0.east] (C0) {\rotatebox{90}{\scriptsize connected}};
    \end{tikzpicture}
