...
\begin{figure}[p]
    ...
    \hfill
    \includegraphics*{gen-graph-scatter-plain-clique-vs-clique-cilk-t32.pdf}

    \vspace*{1em}

    \includegraphics*{gen-graph-scatter-plain-kdown-vs-kdown-par-t32.pdf}
    \hfill
    \includegraphics*{gen-graph-scatter-plain-kdown-vs-kdown-cilk-t32.pdf}
...
\begin{figure}[p]
    \includegraphics*{gen-graph-scatter-plain-clique-par-t32r-vs-clique-par-t32.pdf}
    \hfill
    \includegraphics*{gen-graph-scatter-plain-clique-cilk-t32r-vs-clique-cilk-t32.pdf}

    \vspace*{1em}

    \includegraphics*{gen-graph-scatter-plain-kdown-par-t32r-vs-kdown-par-t32.pdf}
    \hfill
    \includegraphics*{gen-graph-scatter-plain-kdown-cilk-t32r-vs-kdown-cilk-t32.pdf}
...
\begin{figure}[p]
    ...
    \hfill
    \includegraphics*{gen-graph-scatter-33v-clique-vs-clique-cilk-t32.pdf}
...
\begin{figure}[p]
    \includegraphics*{gen-graph-scatter-33v-clique-par-t32r-vs-clique-par-t32.pdf}
    \hfill
    \includegraphics*{gen-graph-scatter-33v-clique-cilk-t32r-vs-clique-cilk-t32.pdf}

    \vspace*{1em}

    \includegraphics*{gen-graph-scatter-33v-mcsplit-par-t32r-vs-mcsplit-par-t32.pdf}
...
\begin{figure}[p]
    ...
    \hfill
    \includegraphics*{gen-graph-scatter-33ved-clique-vs-clique-cilk-t32.pdf}
...
\begin{figure}[p]
    ...
    \includegraphics*{gen-graph-scatter-33ved-mcsplit-par-t32r-vs-mcsplit-par-t32.pdf}
