...
\begin{figure}[p]
    ...
    \caption{Per-instance speedups for unlabelled, undirected graphs. The histograms show the
    distribution of speedups for instances whose sequential runtime is at least $50$ milliseconds
    and no more than $100$ seconds (and so they under-represent superlinear speedups slightly).}
\end{figure}
...
\begin{figure}[t]
    ...
    \includegraphics*{gen-graph-histogram-sip-kdown-vs-kdown-par-t32.pdf}
    \hfill
    \includegraphics*{gen-graph-histogram-sip-mcsplit-vs-mcsplit-par-t32.pdf}
