...
set terminal tikz standalone color size 2.4in,1.2in font '\scriptsize' preamble '\input{gnuplot-preamble}'
set output "gen-graph-pp2-plain-connected-clique-vs-clique-par-t32.tex"

seqcol=2
parcol=4
starttime=5e2
runtimes="../experiments/fatanode-results/mcsplain-connected/runtimes.data"
...
set xtics nomirror
set ytics nomirror
set key outside right maxcols 1 maxrows 9
set format x '$10^{%T}$'
