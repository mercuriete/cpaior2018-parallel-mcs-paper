...
plot \
    '<../paper/asify.sh gen-as-alt-plain-kdown-par.data gen-as-alt-plain-kdown-seq.data' u 3:($3/$2) w l title 'Unlabelled' at end ls 1, \
    '<../paper/asify.sh gen-as-alt-sip-kdown-par.data gen-as-alt-sip-kdown-seq.data' u 3:($3/$2) w l title 'Large' at end ls 8
