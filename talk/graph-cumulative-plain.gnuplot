...
set xtics nomirror
set ytics nomirror
set key bottom width -3 samplen 1
set format x '$10^{%T}$'
...
plot \
    ...
    "../experiments/fatanode-results/mcsplain/runtimes.data" u 4:($4>=1e6?1e-10:1) smooth cumulative w l ti 'k${\downarrow}$' ls 4, \
    ...
    "../experiments/fatanode-results/mcsplain/runtimes.data" u 7:($7>=1e6?1e-10:1) smooth cumulative w l notitle ls 4 dt '.'
