...
plot \
    '<../paper/asify.sh gen-as-alt-plain-mcsplit-par.data gen-as-alt-plain-mcsplit-seq.data' u 3:($3/$2) w l title 'Unlabelled' at end ls 1, \
    '<../paper/asify.sh gen-as-alt-33v-mcsplit-par.data gen-as-alt-33v-mcsplit-seq.data' u 3:($3/$2) w l title '\raisebox{0mm}{Vertex}' at end ls 2, \
    '<../paper/asify.sh gen-as-alt-33ved-mcsplit-par.data gen-as-alt-33ved-mcsplit-seq.data' u 3:($3/$2) w l title '\raisebox{1mm}{Both, dir.}' at end ls 4, \
    '<../paper/asify.sh gen-as-alt-plain-connected-mcsplit-par.data gen-as-alt-plain-connected-mcsplit-seq.data' u 3:($3/$2) w l title '\raisebox{2mm}{Unlabelled, conn.}' at end ls 6, \
    '<../paper/asify.sh gen-as-alt-33ve-connected-mcsplit-par.data gen-as-alt-33ve-connected-mcsplit-seq.data' u 3:($3/$2) w l title '~~~~~Both, conn.' at end ls 7, \
    '<../paper/asify.sh gen-as-alt-sip-mcsplit-par.data gen-as-alt-sip-mcsplit-seq.data' u 3:($3/$2) w l title 'Large' at end ls 8
